...
import com.minatoorgtestcase.exporttesting1.model.Roles;
...
import com.minatoorgtestcase.exporttesting1.base.model.constants.ExportTesting1Table1ConstantBase;
...
@Component
public abstract class ExportTesting1Table1PerimeterBaseImpl<T extends ExportTesting1Table1Base> implements IPerimeterManager<T>, ExportTesting1Table1ConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(ExportTesting1Table1PerimeterBaseImpl.class);
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase == null) {
			...
			return;
					...
					if (BooleanUtils.isTrue(userBase.isItachi())) {
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, SYNC_TIME, EXPORTTESTING1TABLE1FIELD1, EXPORTTESTING1TABLE1FIELD2};
			...
			if (BooleanUtils.isTrue(userBase.isMinato())) {
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, SYNC_TIME, EXPORTTESTING1TABLE1FIELD1, EXPORTTESTING1TABLE1FIELD2};
			allowedAccessFields.addAll(Arrays.asList(readFields));
		}
