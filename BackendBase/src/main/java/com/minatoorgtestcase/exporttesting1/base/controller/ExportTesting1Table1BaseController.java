package com.minatoorgtestcase.exporttesting1.base.controller;
...
import com.minatoorgtestcase.exporttesting1.base.service.IExportTesting1Table1BaseService;
...
public abstract class ExportTesting1Table1BaseController<SERVICE extends IExportTesting1Table1BaseService<M>, M extends ExportTesting1Table1Base>
		extends BaseWebService<SERVICE, M> {
	
	
	public ExportTesting1Table1BaseController(SERVICE logic) {
		super(logic);
	}
	
	
	//@PreAuthorize("hasAccess('/exporttesting1table1s/datatable')")
	...
	//@PreAuthorize("hasAccess('/exporttesting1table1s/')")
	@PutMapping
	...
	//@PreAuthorize("hasAccess('/exporttesting1table1s/{sid}')")
	...
	//@PreAuthorize("hasAccess('/exporttesting1table1s/autosuggest')")
	...
	//@PreAuthorize("hasAccess('/exporttesting1table1s/{ids}')")
	@DeleteMapping("/{ids}")
