...
import com.minatoorgtestcase.exporttesting1.base.model.constants.ApplicationUserConstantBase;
...
public abstract class ApplicationUserPerimeterBaseImpl<T extends ApplicationUserBase> implements IPerimeterManager<T>, ApplicationUserConstantBase {
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase!=null) {
			...
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, SYNC_TIME, EMAIL, FIRST_NAME, LAST_NAME, USER_ROLES, APP_ADMIN, MINATO, ITACHI};
