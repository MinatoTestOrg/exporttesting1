package com.minatoorgtestcase.exporttesting1.base.dataexport.finalizer;
...
import com.minatoorgtestcase.exporttesting1.base.service.ApplicationUserBaseService;
...
public class ExportTesting1Table1BaseExportFinalizer extends ExportFinalizer<RappitExport> {
	
	private ApplicationUserBaseService  applicationUserBaseService;
	public ExportTesting1Table1BaseExportFinalizer(ApplicationUserBaseService applicationUserBaseService, boolean isChunk) {
		super(isChunk);
