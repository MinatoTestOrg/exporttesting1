import { Exporttesting1table1Service } from '../exporttesting1table1.service';
...
import { Exporttesting1table1ApiConstants } from '@baseapp/exporttesting1table1/exporttesting1table1/exporttesting1table1.api-constants';
...
export class Exporttesting1table1ListBaseComponent{
	
	
	displayExport: boolean = false;
exportTableName: string ="exportTesting1Table1";
	quickFilter: any;
hiddenFields:any = {};
...
isMobile: boolean = AppConstants.isMobile;
  ...
  gridData: Exporttesting1table1Base[] = [];
...
localStorageStateKey = "exporttesting1table1-list";
...
first: number =0;
rows: number = 0;
updatedRecords:Exporttesting1table1Base[] = [];
...
@ViewChild('toggleButton')
 ...
 filtersApplied:boolean = false;
  ...
  "children" : [ {
    ...
    "fieldName" : "exporttesting1table1field1",
    "data" : "",
    "field" : "exporttesting1table1field1",
    "name" : "exporttesting1table1field1",
    "uiType" : "text",
    "isPrimaryKey" : false,
    "label" : "EXPORTTESTING1TABLE1FIELD1",
    "type" : "searchField",
    "fieldType" : "string",
    "fieldId" : "exporttesting1table1field1"
  }, {
    "multipleValues" : false,
    "fieldName" : "exporttesting1table1field2",
    "data" : "",
    "field" : "exporttesting1table1field2",
    "name" : "exporttesting1table1field2",
    "uiType" : "text",
    "isPrimaryKey" : false,
    "label" : "EXPORTTESTING1TABLE1FIELD2",
    "type" : "searchField",
    "fieldType" : "string",
    "fieldId" : "exporttesting1table1field2"
  } ],
  "columns" : "2",
  "type" : "tableSearch",
  ...
  "showGridlines" : false,
  "detailPage" : {
    "sid" : "c00bed33-87e8-491d-9489-94f0b1ccb224",
    "name" : "exportTesting1Table1 Detail",
    "url" : "/exporttesting1table1/exporttesting1table1detail"
  },
  "detailPageNavigation" : "click_of_the_row"
}
	pageViewTitle: string = 'EXPORTTESTING1TABLE1_LIST';
	
	public exporttesting1table1Service = inject(Exporttesting1table1Service);
...
public location = inject(Location);
	...
	exporttesting1table1field1: new UntypedFormControl('',[]),
	exporttesting1table1field2: new UntypedFormControl('',[]),
});
  ...
  if (formControl.controls[parent] instanceof FormGroup){
	...
	let property: Exclude<keyof Exporttesting1table1ListBaseComponent, ''> = value;
	if (this.isChildPage && this[property]) {
		const methodName: any = "onNewChild";
		let action: Exclude<keyof Exporttesting1table1ListBaseComponent, ''> = methodName;
		if (typeof this[action] == "function") {
			this[action]();
		}
	}
	else {
		this.router.navigate(['../exporttesting1table1detail'], { relativeTo: this.activatedRoute});
	}
}
	clearAllFilters() {
...
onExportSucess() {
    ...
    if (environment.prototype && this.tableConfig.children?.length > 0) {
      gridSubscription = this.exporttesting1table1Service.getProtoTypingData().subscribe((data: any) => {
  ...
  this.showAdvancedSearch = !this.showAdvancedSearch;
    ...
    return {
      ...
      ajaxUrl: Exporttesting1table1ApiConstants.getDatatableData,
      select: true,
...
if (hasDates.length > 0) {
    ...
    if (this.selectedValues.length > 0) {
      ...
      this.confirmationService.confirm({
        ...
        accept: () => {
          const deleteSubscription = this.exporttesting1table1Service.delete(requestedParams).subscribe((res: any) => {
