...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"outline":false,"infiniteScroll":false,"urlIconFileName":"Company Logo.svg","valueChange":true,"logoFileName":"Company Logo.svg","currentNode":"5d4dd9f2-c9e1-4d22-9d9d-71dff4bac095","mobileLogoFileName":"Company Logo.svg","element":"logo"},{"outline":false,"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"outline":false,"element":"appTitle"}],"middle":[{"outline":false,"element":"leftPane"},{"outline":false,"element":"middlePane"},{"outline":false,"element":"rightPane"}],"right":[{"outline":false,"menuType":"float","element":"rightMenu"},{"children":[{"outline":false,"link":"/logout","label":"Logout","element":"logout"}],"element":"user"}]};
