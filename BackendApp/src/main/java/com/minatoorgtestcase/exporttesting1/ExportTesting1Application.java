package com.minatoorgtestcase.exporttesting1;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatoorgtestcase.exporttesting1"})
@EnableCaching
...
public class ExportTesting1Application {

	public static void main(String[] args) {
		SpringApplication.run(ExportTesting1Application.class, args);
	}
